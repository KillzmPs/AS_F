...
--
-- Host: localhost:3306
-- Tempo de geração: 15-Abr-2025 às 15:48
...
(2, 'Aeroporto Francisco Sá Carneiro', 'Pedras Rubras, Maia', 142),
...
--
-- Índices para tabela `Bilhete_Viagem`
--
ALTER TABLE `Bilhete_Viagem`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `Id_Bilhete` (`Id_Bilhete`),
...
--
-- AUTO_INCREMENT de tabela `Bilhete_Quarto`
--
ALTER TABLE `Bilhete_Quarto`
  MODIFY `Id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `Bilhete_Viagem`
--
ALTER TABLE `Bilhete_Viagem`
  MODIFY `Id` int NOT NULL AUTO_INCREMENT;
...
--
-- Limitadores para a tabela `Bilhete_Viagem`
--
ALTER TABLE `Bilhete_Viagem`
  ADD CONSTRAINT `Bilhete_Viagem_ibfk_1` FOREIGN KEY (`Id_Bilhete`) REFERENCES `Bilhete` (`Id`),
  ADD CONSTRAINT `Bilhete_Viagem_ibfk_2` FOREIGN KEY (`Id_Viagem`) REFERENCES `Viagem` (`Id`);
